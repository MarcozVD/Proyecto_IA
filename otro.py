# -*- coding: utf-8 -*-
"""Copia de Preprocesamiento metro-p3.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Y81Wl1U-C6jViCeDelHyx_Ykjl8gTQ1i
"""

# --- Configuración inicial para trabajar en Google Colab ---
...
res_df = pd.DataFrame(resultados).T[['accuracy','f1_score','recall']]
res_df = res_df.sort_values(by='f1_score', ascending=False)
